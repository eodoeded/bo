...
export default function BrandGuidelines() {
  ...
  return (
    <div className="min-h-screen bg-[#261E19] text-white p-8">
      {/* Super visible test banner */}
      <div className="fixed top-0 left-0 right-0 bg-red-600 text-white p-4 text-center z-[9999] font-bold text-lg">
        ✅ BRAND GUIDELINES PAGE IS LOADING - IF YOU SEE THIS, THE ROUTE WORKS!
      </div>
