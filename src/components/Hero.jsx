...
export default function Hero() {
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-[#12110D] to-[#1C1A14]">
      <div className="w-full max-w-7xl mx-auto px-16 flex items-center justify-between">
        ...
        <div className="relative w-1/2 flex justify-center">
          <motion.img
            ...
            className="w-[200px] h-[120px] absolute z-10 -top-4 -right-8"
            animate={{ y: [0, -8, 0] }}
