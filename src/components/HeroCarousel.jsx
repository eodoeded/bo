...
const slides = [
  ...
  },
  {
    ...
    middleImg: middle1,
    upImg: top1,
    bottomWidth: "w-[360px] md:w-[600px] max-w-none",
    middleWidth: "w-[1080px] md:w-[1800px] max-w-none",
    upWidth: "w-[1080px] md:w-[1800px] max-w-none",
    upMargin: "-mb-36 md:-mb-72",
    middleMargin: "-mb-24 md:-mb-48",
    bottomAnimate: { y: [0, -6, 0] },
